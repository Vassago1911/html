...
var $author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			$elm$svg$Svg$Attributes$viewBox('0 0 2048 2048')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$width('2304'),
					$elm$svg$Svg$Attributes$height('2304'),
					$elm$svg$Svg$Attributes$fill('#303')
				]),
			_List_Nil),
			A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$fill('#101')
				]),
			_List_Nil),
			A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$rx('15'),
					$elm$svg$Svg$Attributes$ry('15'),
					$elm$svg$Svg$Attributes$fill('#189')
				]),
			_List_Nil)
		]));
